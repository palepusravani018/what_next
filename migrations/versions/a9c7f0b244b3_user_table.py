...
Revision ID: a9c7f0b244b3
Revises: 
Create Date: 2025-03-06 21:57:01.754329
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_qualification'), ['qualification'], unique=True)
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_user_qualification'))
